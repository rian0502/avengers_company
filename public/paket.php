...
<head>
    ...
    <title>AvengerNet || Paket & Promo </title>
    <!-- Favicon-->
            ...
            <div class="row gx-5 justify-content-center">
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="card bg-primary text-white">
                        <div class="card-body p-5">
                            <div class="small text-uppercase fw-bold">Rp. 15.000.000 <span class="badge bg-danger">Promo!</span></div>
                            <div class="mb-3">
                            ...
                            <div class="d-grid"><a class="btn btn-light text-primary" href="#!">Choose plan</a></div>
                        </div>
                    </div>
                </div>
                <!-- Pricing card pro-->
