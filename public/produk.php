    ...
    <section class="bg-light py-5 border-bottom">
        <div class="container px-5 my-5">
            <div class="text-center mb-5">
                ...
                <p class="lead mb-0">Produk & Layanan Avenger Net</p>
            </div>
            <div class="row gx-5 justify-content-center">
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="card mb-5 mb-xl-0">
                        <div class="card-body p-5">
                            <div class="small text-uppercase fw-bold text-muted">Jasa Akses Internet</div>
                            <div class="mb-3">
                                <span class="display-4 fw-bold">Wifi</span>
                            </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="card mb-5 mb-xl-0">
                        <div class="card-body p-5">
                            <div class="small text-uppercase fw-bold text-muted">Layanan Televisi Digital</div>
                            <div class="mb-3">
                                <span class="display-4 fw-bold">Tv Kabel</span>
                            </div>
